...
sections:
  - block: hero
    content:
      ...
      text: |
        <style>
          /* 1. Nuke all scroll locks */
          html, body, .page-wrapper {
            height: auto !important;
            overflow: visible !important;
          }
          
          /* 2. Force HugoBlox's internal containers to be wide for the hero section */
          #section-hero .hero-block-container, 
        ...
        <!-- Clean, Native Wrapper (No scroll-breaking viewport hacks) -->
        <div style="width: 100%; padding: 4vh 0; min-height: 85vh; text-align: left; color: #ffffff; font-family: 'Roboto', sans-serif; display: flex; flex-direction: column; justify-content: center; box-sizing: border-box;">
          ...
          <!-- Fluid Flexbox Split: Wide on desktop, stacks natively on mobile -->
